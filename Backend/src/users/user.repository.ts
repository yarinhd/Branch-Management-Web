...
import { createBranch, getAllBranchUsers, updateBranch } from '../utils/utils';
...
export default class UserRepository {
    ...
    static getAllBranchUsers(branchName: string) {
        const branchUsers = getAllBranchUsers(branchName);
        return branchUsers;
    }

    static createBranch(branchName: string) {
        const createdBranch = createBranch(branchName);
