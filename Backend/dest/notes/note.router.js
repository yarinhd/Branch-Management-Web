...
// get Note by noteId
exports.noteRouter.get('/:noteId', utils_1.AuthMiddleware, wrapper_1.default.wrapAsync(validationMW_1.Validator.canGetNote), wrapper_1.default.wrapAsync(note_controller_1.default.getNoteById));
