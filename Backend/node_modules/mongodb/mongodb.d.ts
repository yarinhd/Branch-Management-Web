...
/** @public */
export declare type AnyError = MongoServerError | Error;
 ...
 * @category Error
 */
export declare class MongoDriverError extends MongoServerError {
    constructor(message: string);
    get name(): string;
}
 ...
 * @category Error
 */
export declare class MongoNetworkError extends MongoServerError {
    /* Excluded from this release type: [kBeforeHandshake] */
 ...
 * @category Error
 */
export declare class MongoServerError extends MongoServerError {
    codeName?: string;
 ...
 * @category Error
 */
export declare class MongoSystemError extends MongoServerError {
...
export declare class TopologyDescription {
    ...
    get error(): MongoServerError | undefined;
    /**
