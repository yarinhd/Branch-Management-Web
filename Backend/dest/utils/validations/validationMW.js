...
class Validator {
    static async canDeletOrUpdateUser(req, res, next) {
        ...
        await (0, validationUtils_1.isManagerByUserId)(loggedUser, userId);
        next();
    }
    ...
    static async canGetNote(req, res, next) {
        ...
        const noteUserId = (await note_manager_1.default.getNoteById(noteId)).userId;
    ...
    static async canUpdateDeleteNote(req, res, next) {
        ...
        const { noteId } = req.params;
        const noteUserId = (await note_manager_1.default.getNoteById(noteId)).userId;
        await (0, validationUtils_1.isManagerByUserId)(loggedUser, noteUserId);
        next();
    }
    ...
    static async canUpdateDeleteDocument(req, res, next) {
        ...
        const documentUserId = (await document_manager_1.default.getDocumentById(documentId))
            .userId;
        await (0, validationUtils_1.isManagerByUserId)(loggedUser, documentUserId);
        next();
    }
}
